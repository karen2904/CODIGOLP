...
ADICIONAL: La empresa tiene n carros con diferentes consumos, calcule el cosot anual por vehiculo y el total
de los vehiculos
*/
...
int main(){
	...
	int cstg,cstll,csta,cstm,csttotal=0, otro;
	...
	csttotal=csttotal+csttotal ;
	
	cout<< "\nSi desea ingresar otro valor, digite  "<< endl << "1. Sí. " << "2. No. " << endl;
    cin >> otro;
    
    }
    while(otro==1);
    
   	cout<<"El costo total del consumo de todos los carros es " <<csttotal<<endl;
